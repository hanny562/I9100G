/**
 * arch/arm/mach-omap2/mux_q1_rev_r00.c
 *
...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	OMAP4_MUX(GPMC_AD9, OMAP_MUX_MODE3 | OMAP_PIN_INPUT |OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(GPMC_A16, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP), 
	/* [--OUT] gpmc_a17 - gpio_41 - 8M_ISP_INT */
	OMAP4_MUX(GPMC_A17, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
	...
	OMAP4_MUX(GPMC_A20, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP | OMAP_WAKEUP_EN),
	/* [--OUT] gpmc_a21 - gpio_45 - GYRO_INT */
	OMAP4_MUX(GPMC_A21, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [IN---] gpmc_a22 - gpio_46 - TOUCH_nINT */
	OMAP4_MUX(GPMC_A22, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
	...
	OMAP4_MUX(CAM_SHUTTER, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT7, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(I2C3_SCL, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [INOUT] i2c3_sda - gpio_131 - AP_I2C_SDA */
	OMAP4_MUX(I2C3_SDA, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [--OUT] i2c4_scl - gpio_132 - GEN_I2C_SCL */
	OMAP4_MUX(I2C4_SCL, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [INOUT] i2c4_sda - gpio_133 - GEN_I2C_SDA */
	OMAP4_MUX(I2C4_SDA, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	...
	OMAP4_MUX(MCSPI1_CS2, OMAP_MUX_MODE1 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] mcspi1_cs3 - gpio_140 - GPS_UART_RTS */
	OMAP4_MUX(MCSPI1_CS3, OMAP_MUX_MODE1 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] uart3_cts_rctx - gpio_141 - GPS_UART_TXD */
	OMAP4_MUX(UART3_CTS_RCTX, OMAP_MUX_MODE1 | OMAP_PIN_INPUT),

	/* [--OUT] uart3_rts_sd - gpio_142 */
	...
	OMAP4_MUX(USBB2_HSIC_DATA, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
	...
	/* [-N-C-] kpd_col2 - gpio_1 - USB_OTG_ID */
	OMAP4_MUX(KPD_COL2, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP | OMAP_WAKEUP_EN),
	...
	/* [--OUT] dpm_emu9 - gpio_20 - NFC_FIRM */
	OMAP4_MUX(DPM_EMU9, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [--OUT] dpm_emu10 - gpio_21 - NFC_VEN */
	OMAP4_MUX(DPM_EMU10, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [--OUT] dpm_emu11 - gpio_22 - NFC_IRQ */
	OMAP4_MUX(DPM_EMU11, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
	/* [--OUT] dpm_emu12 - gpio_23 - NFC_SDA */
	OMAP4_MUX(DPM_EMU12, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] dpm_emu13 - gpio_24 - NFC_SCL */
	OMAP4_MUX(DPM_EMU13, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] dpm_emu14 - gpio_25 - PEN_LDO_EN */
	OMAP4_MUX(DPM_EMU14, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [--OUT] dpm_emu15 - gpio_26 - PEN_PDCT_1.8V */
	OMAP4_MUX(DPM_EMU15, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] dpm_emu16 - gpio_27 - PEN_SLP_1.8V */
	OMAP4_MUX(DPM_EMU16, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [--OUT] dpm_emu17 - gpio_28 - PEN_IRQ_1.8V */
	OMAP4_MUX(DPM_EMU17, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
...
static struct omap_board_mux __omap_board_wk_mux[] __initdata = {
	...
	OMAP4_MUX(SIM_IO, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(FREF_CLK3_REQ, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(FREF_CLK4_OUT, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	/* [IN---] sys_pwron_reset_out - - BAT_REMOVAL */
	OMAP4_MUX(SYS_PWRON_RESET_OUT, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),

	/* [-----] jtag_ntrst -  - AP_JTAG_nTRST */
	OMAP4_MUX(JTAG_NTRST, OMAP_PIN_INPUT_PULLUP),
	/* [-----] jtag_tck -  - AP_JTAG_TCK */
	OMAP4_MUX(JTAG_TCK, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP),
	/* [-----] jtag_rtck -	- AP_JTAG_RTCK */
	OMAP4_MUX(JTAG_RTCK, OMAP_PULL_ENA | OMAP_PULL_UP),
	...
	OMAP4_MUX(JTAG_TDO, OMAP_PIN_INPUT_PULLUP),
	{.reg_offset = OMAP_MUX_TERMINATOR},
};
