/**
 * arch/arm/mach-omap2/mux_t1_rev_r00.c
 *
...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	OMAP4_MUX(GPMC_AD9, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [--OUT] gpmc_ad10 - gpio_34 - IMAGE_I2C_SCL */
	OMAP4_MUX(GPMC_AD10, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] gpmc_ad11 - gpio_35 - IMAGE_I2C_SDA */
	...
	/* [IN---] gpmc_a16 - gpio_40 - TOUCH_RST */
	OMAP4_MUX(GPMC_A16, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT), 
	/* [--OUT] gpmc_a17 - gpio_41 - 8M_ISP_INT */
	OMAP4_MUX(GPMC_A17, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	/* [--OUT] gpmc_a18 - gpio_42 - FM_RST */
	OMAP4_MUX(GPMC_A18, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [--OUT] gpmc_a19 - gpio_43 - CAM_PMIC_EN */
	OMAP4_MUX(GPMC_A19, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	...
	OMAP4_MUX(GPMC_NCS1, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	...
	OMAP4_MUX(GPMC_NWP, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	/* [--OUT] gpmc_clk - gpio_55 - JIG_ON_18 */
	OMAP4_MUX(GPMC_CLK, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),

	/* [IN---] gpmc_nadv_ale - gpio_56 - SUSPEND_REQUEST */
	OMAP4_MUX(GPMC_NADV_ALE, OMAP_MUX_MODE7),

	/* [--OUT] gpmc_nbe0_cle - gpio_59 - ACC_EN */
	...
	OMAP4_MUX(GPMC_WAIT2, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	/* [--OUT] gpmc_ncs4 - gpio_101 - IMA_nRST */
	OMAP4_MUX(GPMC_NCS4, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] gpmc_ncs5 - gpio_102 - IMA_BYPASS */
	OMAP4_MUX(GPMC_NCS5, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] gpmc_ncs6 - gpio_103 - IMA_PWR_EN */
	OMAP4_MUX(GPMC_NCS6, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] gpmc_ncs7 - gpio_104 - IMA_SLEEP */
	OMAP4_MUX(GPMC_NCS7, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	...
	OMAP4_MUX(CSI22_DX0, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [IN---] csi22_dy0 - gpio_78 - VT_CAM_CLK_N */
	OMAP4_MUX(CSI22_DY0, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [IN---] csi22_dx1 - gpio_79 - VT_CAM_DP */
	OMAP4_MUX(CSI22_DX1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [IN---] csi22_dy1 - gpio_80 - VT_CAM_DN */
	OMAP4_MUX(CSI22_DY1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
#endif

	/* [IN---] cam_shutter - gpio_81 - WLAN_HOST_WAKE */
	OMAP4_MUX(CAM_SHUTTER, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [--OUT] cam_strobe - gpio_82 - BT_nRST */
	OMAP4_MUX(CAM_STROBE, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [IN---] cam_globalreset - gpio_83 - BT_HOST_WAKE */
	OMAP4_MUX(CAM_GLOBALRESET, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(USBB1_ULPITLL_NXT, OMAP_MUX_MODE1 | OMAP_PIN_INPUT),
	/* [--OUT] usbb1_ulpitll_dat0 - gpio_88 - MIPI_HSI_RX_WAKE */
	OMAP4_MUX(USBB1_ULPITLL_DAT0, OMAP_MUX_MODE1 | OMAP_PIN_INPUT),
	/* [--OUT] usbb1_ulpitll_dat1 - gpio_89 - MIPI_HSI_RX_DATA */
	OMAP4_MUX(USBB1_ULPITLL_DAT1, OMAP_MUX_MODE1 | OMAP_PIN_INPUT),
	/* [--OUT] usbb1_ulpitll_dat2 - gpio_90 - MIPI_HSI_RX_FLG */
	OMAP4_MUX(USBB1_ULPITLL_DAT2, OMAP_MUX_MODE1 | OMAP_PIN_INPUT),
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT6, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [IN---] usbb1_ulpitll_dat7 - gpio_95 - MOTOR_PWM */
	OMAP4_MUX(USBB1_ULPITLL_DAT7, OMAP_MUX_MODE1 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	...
	OMAP4_MUX(SDMMC1_CMD, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [INOUT] sdmmc1_dat0 - gpio_102 - T_FLASH_D(0) */
	OMAP4_MUX(SDMMC1_DAT0, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [INOUT] sdmmc1_dat1 - gpio_103 - T_FLASH_D(1) */
	OMAP4_MUX(SDMMC1_DAT1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [INOUT] sdmmc1_dat2 - gpio_104 - T_FLASH_D(2) */
	OMAP4_MUX(SDMMC1_DAT2, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [INOUT] sdmmc1_dat3 - gpio_105 - T_FLASH_D(3) */
	OMAP4_MUX(SDMMC1_DAT3, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	...
	OMAP4_MUX(UART2_CTS, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [--OUT] uart2_rts - gpio_124 - BT_UART_RTS */
	OMAP4_MUX(UART2_RTS, OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_INPUT_PULLUP),
	/* [--OUT] uart2_rx - gpio_125 - BT_UART_RXD */
	OMAP4_MUX(UART2_RX, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [IN---] uart2_tx - gpio_126 - BT_UART_TXD */
	OMAP4_MUX(UART2_TX, OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_INPUT_PULLUP),
	...
	/* [IN---] mcspi1_cs2 - gpio_139 - GPS_UART_RTS */
	OMAP4_MUX(MCSPI1_CS2, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	/* [--OUT] mcspi1_cs3 - gpio_140 - GPS_UART_CTS */
	...
	/* [--OUT] uart3_rts_sd - gpio_142 - CHG_EN */
	//OMAP4_MUX(UART3_RTS_SD, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	OMAP4_MUX(UART3_RTS_SD, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),

	/* [IN---] uart3_rx_irrx - gpio_143 - AP_FLM_RXD */
	OMAP4_MUX(UART3_RX_IRRX, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	/* [--OUT] uart3_tx_irtx - gpio_144 - AP_FLM_TXD */
	OMAP4_MUX(UART3_TX_IRTX, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	...
	OMAP4_MUX(SDMMC5_CMD, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
	/* [INOUT] sdmmc5_dat0 - gpio_147 - WLAN_SD_D(0) */
	OMAP4_MUX(SDMMC5_DAT0, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
	/* [INOUT] sdmmc5_dat1 - gpio_148 - WLAN_SD_D(1) */
	OMAP4_MUX(SDMMC5_DAT1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
	/* [INOUT] sdmmc5_dat2 - gpio_149 - WLAN_SD_D(2) */
	OMAP4_MUX(SDMMC5_DAT2, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
	/* [INOUT] sdmmc5_dat3 - gpio_150 - WLAN_SD_D(3) */
	OMAP4_MUX(SDMMC5_DAT3, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
	...
	/* [IN---] kpd_col3 - gpio_171 - MLCD_ON */
	OMAP4_MUX(KPD_COL3, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
	/* [-N-C-] kpd_col4 - gpio_172 - AP_AGPS_TSYNC */
	OMAP4_MUX(KPD_COL4, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
	/* [-N-C-] kpd_col5 - gpio_173 - LCD_LDO_EN */
	...
	/* [--OUT] kpd_col1 - gpio_0 - KBC(1) */
	OMAP4_MUX(KPD_COL1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	/* [-N-C-] kpd_col2 - gpio_1 - MLCD_ON1 */
	OMAP4_MUX(KPD_COL2, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
	/* [IN---] kpd_row3 - gpio_175 - MHL_INT */
	OMAP4_MUX(KPD_ROW3, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [IN---] kpd_row4 - gpio_176 - HOME_KEY */
	OMAP4_MUX(KPD_ROW4, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	/* [IN---] kpd_row1 - gpio_2 - KBR(1) */
	OMAP4_MUX(KPD_ROW1, OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	/* [IN---] kpd_row2 - gpio_3 - KBR(2) */
	OMAP4_MUX(KPD_ROW2, OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(FREF_CLK2_OUT, OMAP_MUX_MODE0 | OMAP_PIN_INPUT),
	...
	/* [--OUT] dpm_emu2 - gpio_13 - OLED_ID (rev0.0) / CHG_EN (rev0.1) */
	OMAP4_MUX(DPM_EMU2, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
#if 0
	/* [--OUT] mcspi4_clk - gpio_151 - LCD_SCLK */
	OMAP4_MUX(MCSPI4_CLK, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [--OUT] mcspi4_simo - gpio_152 - LCD_SDI */
	OMAP4_MUX(MCSPI4_SIMO, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_INPUT_PULLDOWN),
	/* [--OUT] mcspi4_cs0 - gpio_154 - LCD_nCS */
	OMAP4_MUX(MCSPI4_CS0, OMAP_MUX_MODE0 | OMAP_PIN_INPUT_PULLUP | OMAP_PIN_OFF_OUTPUT_HIGH),
#endif
...
static struct omap_board_mux __omap_board_wk_mux[] __initdata = {
	...
	OMAP4_MUX(SIM_IO, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),

	/* [IN---] sim_clk - gpio_wk1 - CP_DUMP_INT */
	OMAP4_MUX(SIM_CLK, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	...
	/* [IN---] sim_pwrctrl - gpio_wk4 - MOTOR_EN */
	OMAP4_MUX(SIM_PWRCTRL, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),

	/* [-----] fref_clk0_out - sys_drm_msecure - SYS_DRM_MSEC */
	OMAP4_MUX(FREF_CLK0_OUT, OMAP_MUX_MODE2 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_INPUT_PULLDOWN),

	/* [-N-C-] fref_clk3_out - gpio_wk31 - NC */
	OMAP4_MUX(FREF_CLK3_OUT, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
	...
	OMAP4_MUX(FREF_CLK3_REQ, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
	/* [IN---] fref_clk4_out - gpio_wk8 - VOL_DOWN */
	OMAP4_MUX(FREF_CLK4_OUT, OMAP_MUX_MODE3 | OMAP_PIN_INPUT),
