...
static int __init omap_smartreflex_probe(struct platform_device *pdev)
{
	...
	(void) debugfs_create_file("autocomp", 0660, dbg_dir,
				(void *)sr_info, &pm_sr_fops);
	(void) debugfs_create_file("errweight", 0660, dbg_dir,
				&sr_info->err_weight, &sr_params_fops);
	(void) debugfs_create_file("errmaxlimit", 0660, dbg_dir,
				&sr_info->err_maxlimit, &sr_params_fops);
	(void) debugfs_create_file("errminlimit", 0660, dbg_dir,
