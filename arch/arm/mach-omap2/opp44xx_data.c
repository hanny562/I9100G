...
static struct omap_opp_def __initdata omap44xx_opp_def_list[] = {
	...
	OMAP_OPP_DEF("mpu", false, 196608000, 950000),
	/* MPU OPP1 - OPP50 */
	OMAP_OPP_DEF("mpu", true, 300000000, 975000),
	/* MPU OPP2 - OPP100 */
	OMAP_OPP_DEF("mpu", true, 600000000, 1150000),
	/* MPU OPP3 - OPP-Turbo */
	OMAP_OPP_DEF("mpu", true, 800000000, 1275000),
	/* MPU OPP4 - OPP-SB */
	OMAP_OPP_DEF("mpu", true, 1008000000, 1359000),
	/* MPU OPP4 - OPP-TNT */
	OMAP_OPP_DEF("mpu", false, TNT_FREQ, 1360000),
	...
	OMAP_OPP_DEF("dsp", false, 98304000, 948000),
	/* DSP OPP1 - OPP50 */
	...
	/* ABE OPPLP - DPLL cascading */
	OMAP_OPP_DEF("omap-aess-audio", false, 98304000, 948000),
	/* ABE OPP1 - OPP50 */
	OMAP_OPP_DEF("omap-aess-audio", true, 98304000, 950000),
	/* ABE OPP2 - OPP100 */
	OMAP_OPP_DEF("omap-aess-audio", true, 196600000, 1114000),
	/* ABE OPP3 - OPPTB */
	OMAP_OPP_DEF("omap-aess-audio", false, 196600000, 1291000),
...
/* Check for 1.2Ghz support on the silicon.
	 *   Reg to read is OMAP4_CTRL_MODULE_CORE_STD_FUSE_PROD_ID_1
	 *   Bits SILICON_TYPE[17:16] == 2 then device supports 1.2Ghz. 
	 * If supported then enable 1.2GHz opp.
	*/				
    has_tnt_opp = omap_ctrl_readl(OMAP4_CTRL_MODULE_CORE_STD_FUSE_PROD_ID_1);
	has_tnt_opp = ((has_tnt_opp >> 16) & 0x3);	
	...
	if (has_tnt_opp == 2) {
		...
		if (IS_ERR(tnt_opp))
			...
			opp_enable(tnt_opp);
			pr_info("Enable OverClock OPP(rate=%d)\n", TNT_FREQ);
		}
	} else {
		pr_info("Not Support OverClock OPP(rate=%d)\n", TNT_FREQ);
	}
