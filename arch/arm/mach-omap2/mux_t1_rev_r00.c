...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT6, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
...
static struct omap_board_mux __omap_board_wk_mux[] __initdata = {
	...
	OMAP4_MUX(FREF_CLK3_REQ, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
	/* [-N-C-] fref_clk4_out - gpio_wk8 - NC */
	OMAP4_MUX(FREF_CLK4_OUT, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
