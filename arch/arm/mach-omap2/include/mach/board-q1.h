/**
 * arch/arm/mach-omap2/include/mach/board-q1.h
 *
...
#ifndef __BOARD_Q1_H__
#define __BOARD_Q1_H__

#ifdef CONFIG_MACH_SAMSUNG_Q1 /* T1 hostwakeup */
	typedef irqreturn_t (*wl_isr_t)(int irq, void* dev_id);
#endif

#endif /* __BOARD_Q1_H__ */
