...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	//OMAP4_MUX(GPMC_AD8, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
	...
	OMAP4_MUX(GPMC_NCS4, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	/* [--OUT] gpmc_ncs5 - gpio_102 - 3_TOUCH_LED_EN */
	OMAP4_MUX(GPMC_NCS5, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT6, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP |OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(KPD_COL2, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
...
static struct omap_board_mux __omap_board_wk_mux[] __initdata = {
	...
	OMAP4_MUX(SIM_PWRCTRL, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT),
