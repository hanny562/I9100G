...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	/* [IN---] usbb1_ulpitll_dat7 - gpio_95 - MOTOR_EN */
	...
	OMAP4_MUX(ABE_DMIC_DIN1, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
...
//	OMAP4_MUX(UART3_TX_IRTX, OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_HIGH),
	...
	OMAP4_MUX(KPD_ROW4, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN),
