...
static struct omap_board_mux __omap_board_core_mux[] __initdata = {
	...
	/* [--OUT] gpmc_ncs1 - gpio_51 - VT_CAM_nSTBY -> Not used by camera */
	...
	OMAP4_MUX(GPMC_NADV_ALE, OMAP_MUX_MODE3 | OMAP_PIN_INPUT | OMAP_WAKEUP_EN),
	...
	OMAP4_MUX(USBB1_ULPITLL_DAT6, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
...
static struct omap_board_mux __omap_board_wk_mux[] __initdata = {
	...
	OMAP4_MUX(SIM_CLK, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN),
	/* [--OUT] sim_reset - gpio_wk2 - CP_RST */
	OMAP4_MUX(SIM_RESET, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP),
