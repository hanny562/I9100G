...
int omap_emif_suspend(struct platform_device *pdev, pm_message_t state)
{

	u32 temp;
	int id = pdev->id;
	void __iomem *base = emif[id].base;
...
int omap_emif_resume(struct platform_device *pdev)
{
	u32 temp;
	int id = pdev->id;
	void __iomem *base = emif[id].base;
...
static struct platform_driver omap_emif_driver = {
	...
	.suspend 	= omap_emif_suspend,
	.resume 	= omap_emif_resume,
