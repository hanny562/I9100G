...
#include "../mach-omap2/powerdomains.h"
...
int pwrdm_read_pwrst(struct powerdomain *pwrdm)
{
	...
	if (arch_pwrdm->pwrdm_read_pwrst && arch_pwrdm->pwrdm_read_pwrst < PAGE_OFFSET) {
		if (cpu_is_omap24xx() || cpu_is_omap34xx())
			arch_pwrdm = &omap2_pwrdm_functions;
		else if (cpu_is_omap44xx())
			arch_pwrdm = &omap4_pwrdm_functions;

		printk("[%s] Maybe arch_pwrdm is crashed by someone\n", __func__);
	}
