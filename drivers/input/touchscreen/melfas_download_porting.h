...
#define MCSDL_VDD_SET_HIGH()             			gpio_direction_output(OMAP_GPIO_TSP_EN, 1);
#define MCSDL_VDD_SET_LOW()              			gpio_direction_output(OMAP_GPIO_TSP_EN, 0);
#else
...
#define MCSDL_CE_SET_HIGH()   	          			____HERE!_____//gpio_set_value(TOUCH_EN, 1)
#define MCSDL_CE_SET_LOW()      	        			____HERE!_____//gpio_set_value(TOUCH_EN, 0)
#define MCSDL_CE_SET_OUTPUT()   	        		____HERE!_____//gpio_tlmm_config(GPIO_CFG(TOUCH_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
#else
...
#define MCSDL_RESETB_SET_HIGH()             			gpio_direction_output(OMAP_GPIO_TSP_nINT, 1)
#define MCSDL_RESETB_SET_LOW()              			gpio_direction_output(OMAP_GPIO_TSP_nINT, 0)
#define MCSDL_RESETB_SET_OUTPUT()           			//
#define MCSDL_RESETB_SET_INPUT()            			gpio_direction_input(OMAP_GPIO_TSP_nINT)
#else
...
#define MCSDL_GPIO_SCL_SET_HIGH()					gpio_direction_output(OMAP_GPIO_TSP_I2C_SCL, 1)
#define MCSDL_GPIO_SCL_SET_LOW()					gpio_direction_output(OMAP_GPIO_TSP_I2C_SCL, 0)

#define MCSDL_GPIO_SDA_SET_HIGH()					gpio_direction_output(OMAP_GPIO_TSP_I2C_SDA, 1)
#define MCSDL_GPIO_SDA_SET_LOW()					gpio_direction_output(OMAP_GPIO_TSP_I2C_SDA, 0)

#define MCSDL_GPIO_SCL_SET_OUTPUT()				//
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_direction_input(OMAP_GPIO_TSP_I2C_SCL)

#define MCSDL_GPIO_SDA_SET_OUTPUT()				//
#define MCSDL_GPIO_SDA_SET_INPUT()				gpio_direction_input(OMAP_GPIO_TSP_I2C_SDA)

#define MCSDL_GPIO_SDA_IS_HIGH()					((gpio_get_value(OMAP_GPIO_TSP_I2C_SDA) > 0) ? 1 : 0)
