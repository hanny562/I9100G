...
#if defined(CONFIG_MACH_SAMSUNG_T1 )|| defined(CONFIG_MACH_SAMSUNG_Q1)	//BRCM 110614
...
extern void register_isr_wlan(wl_isr_t isr) ;
#endif
...
int bcmsdh_register_oob_intr(void * dhdp)
{
	...
	if (!sdhcinfo->oob_irq_registered) {
		...
		dpll_cascading_blocker_hold(sdhcinfo->dev);		//BRCM 110614
		register_isr_wlan((wl_isr_t*)wlan_oob_irq);
#endif
		if (error)
			return -ENODEV;
...
#if defined(CONFIG_MACH_SAMSUNG_T1 )|| defined(CONFIG_MACH_SAMSUNG_Q1)
		register_isr_wlan(NULL);
		dpll_cascading_blocker_release(sdhcinfo->dev);		//BRCM 110614
#endif
	}
}
#endif /* defined(OOB_INTR_ONLY) */
