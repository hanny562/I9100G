...
#define CMC623_PWM_DEFAULT_INTENSITY	140
...
#define LOW_BACKLIGHT_VALUE_VA 64	// 4
#define DIM_BACKLIGHT_VALUE_VA 64	// 4

#define MAX_BACKLIGHT_VALUE_VA50 1168 //73
#define MID_BACKLIGHT_VALUE_VA50 464 //29
#define LOW_BACKLIGHT_VALUE_VA50 64	// 4
#define DIM_BACKLIGHT_VALUE_VA50 64	// 4

#define MAX_BACKLIGHT_VALUE_PLS 1312 //82
#define MID_BACKLIGHT_VALUE_PLS 528 //33
#define LOW_BACKLIGHT_VALUE_PLS 80	// 5
#define DIM_BACKLIGHT_VALUE_PLS 80	// 5

#define MAX_BACKLIGHT_VALUE_TN	 1408 //88
#define MID_BACKLIGHT_VALUE_TN	 576 //36
#define LOW_BACKLIGHT_VALUE_TN	 80	// 5
#define DIM_BACKLIGHT_VALUE_TN	 80	// 5

#define MAX_BACKLIGHT_VALUE_FFS 1504 //94
#define MID_BACKLIGHT_VALUE_FFS 608 //38
#define LOW_BACKLIGHT_VALUE_FFS 80	// 5
#define DIM_BACKLIGHT_VALUE_FFS 80	// 5

#define MAX_BACKLIGHT_VALUE_LCDPLS	1360 //85
#define MID_BACKLIGHT_VALUE_LCDPLS	 544 //34
#define LOW_BACKLIGHT_VALUE_LCDPLS	 80	// 5
#define DIM_BACKLIGHT_VALUE_LCDPLS	 80	// 5
...
static bool first_tuning_set = TRUE;
...
static int cmc623_pwm_get_tune(int level)
{
	...
	if (first_tuning_set)
		{
		set_tunning_data();
		first_tuning_set = FALSE;
		msleep(100);
		}
	switch(lcd_type)
		{
		case LCD_TYPE_PLS:
//			printk("--- %s : lcd type - LCD_TYPE_PLS \n", __func__);
...
//			gpio_set_value(OMAP_GPIO_LCD_EN_SET, 0);
			gpio_set_value(OMAP_GPIO_MLCD_ON, 0);
